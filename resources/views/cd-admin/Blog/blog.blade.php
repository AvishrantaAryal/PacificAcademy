...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div>
       <a href="{{url('/createblog')}}"> <button type="button" class="btn btn-info">Create Blog</button></a>
     </div>
     <br>
      <div class="box">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
           ...
           <tr>
            ...
            <td>
              <form action="{{url('/updateblogstatus/'.$datas['slug'])}}" method="POST">
                @csrf
                <div class="btn-group">
            ...
            <td> 
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a data-toggle="modal" href="{{URL('/editblog',$datas['slug'])}}">Edit</a></li>
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{url('/deleteblog/'.$datas->slug)}}" method="POST">
                    @method('DELETE')
