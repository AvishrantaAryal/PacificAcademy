...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="{{url()->current()}}">Carousel</a></li>
  </ol>
</section>
      ...
      <div>
        ...
        <div class="box box-primary">
          <div class="box-header with-border">
            <div>
              <h3 class="box-title">View Carousel </h3><br><br>
            </div>
            ...
            <div class="container" id="status">
              ...
              <form action="{{url('/updatecarouselstatus/'.$d->slug)}}" method="POST">
                @csrf
            ...
            <div>
              <img src="{{ url('public/uploads/'.$d->image)}}" alt="">
            </div>
            <div>
