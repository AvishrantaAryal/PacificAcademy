...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div>
       <a href="{{url('/creategoal')}}"> <button type="button" class="btn btn-info">Create Our_Goal</button></a>
     </div>
     <br>
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">View Our Goal Details</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
           ...
           <tr>
            ...
            <td>
              <form action="{{url('/updategoalstatus/'.$datas['id'])}}" method="POST">
                @csrf
                <div class="btn-group">
            ...
            <td> 
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" role="menu">
                 <li><a data-toggle="modal" data-target="#modal{{$datas['id']}}">View</a></li>
                 <li><a data-toggle="modal" href="{{URL('/editgoal',$datas['id'])}}">Edit</a></li>
                 <li><a data-toggle="modal" data-target="#modal-danger{{$datas['id']}}">Delete</a></li>
               </ul>
             </div>
           </td>
         </tr>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <h4 class="modal-title">View Our Goal</h4>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">Our Goal</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{url('/deletegoal/'.$datas->id)}}" method="POST">
                    @method('DELETE')
