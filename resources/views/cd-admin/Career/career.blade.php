...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div>
       <a href="{{url('/createcareer')}}"> <button type="button" class="btn btn-info">Create Career</button></a>
     </div>
     <br>
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">View Career Details</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
           ...
           <tr>
            ...
            <td>
              <form action="{{url('/updatecareerstatus/'.$datas['slug'])}}" method="POST">
                @csrf
                <div class="btn-group">
            ...
            <td> 
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a data-toggle="modal" href="{{URL('/editcareer',$datas['slug'])}}">Edit</a></li>
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{url('/deletecareer/'.$datas->slug)}}" method="POST">
                    @method('DELETE')
