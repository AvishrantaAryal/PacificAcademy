...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="{{url('/managementmessage')}}">Management Message</a></li>
  </ol>
</section>
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div>
       <a href="{{url('/createmessage')}}"> <button type="button" class="btn btn-info">Create Message</button></a>
     </div>
     <br>
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">View Management Message Details</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
           ...
           <tr>
            ...
            <td>
              <form action="{{url('/updatemessagestatus/'.$datas['slug'])}}" method="POST">
                @csrf
                <div class="btn-group">
            ...
            <td> 
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a data-toggle="modal" href="{{URL('/editmessage',$datas['slug'])}}">Edit</a></li>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">Management Message</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{url('/deletemessage/'.$datas->slug)}}" method="POST">
                    @method('DELETE')
