              ...
              <div class="box-body">
               <div class="form-group">
                  ...
                  <select class="form-control" id="exampleFormControlSelect1" name="pagetitle" value="{{old('pagetitle')}}">
                    ...
                    <option value="Accomodation">Notice & Events</option>
                    <option value="Room">Blog</option>
                    <option value="Facilities">Gallery</option>
                    <option value="Contact">Career</option>
                    <option value="Contact">Testimonials</option>
                ...
                <div class="form-group">
                  ...
                  <textarea id="summernote" placeholder="Enter Description" name="seodescription" >{{old('seodescription')}}</textarea>
                  <div class="text text-danger">{{ $errors->first('seodescription') }}</div>
                </div>
                <div>
                  <button type="submit" class="btn btn-info">Add Seo</button>
                </div>
              </form>
