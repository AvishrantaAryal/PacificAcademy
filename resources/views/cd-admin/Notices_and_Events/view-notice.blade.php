...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active"><a href="{{url('/notice')}}">Notices And Events</a></li>
  </ol>
</section>
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <div>
       <a href="{{url('/createnotice')}}"> <button type="button" class="btn btn-info">Create Notice / Event</button></a>
     </div>
     <br>
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">View Notices And Events Details</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="example1" class="table table-bordered table-hover">
           ...
           <tr>
            ...
            <td>{!!e($datas['category'])!!}</td>
            <td>
              <form action="{{url('/updatenoticestatus/'.$datas['slug'])}}" method="POST">
                @csrf
                <div class="btn-group">
            ...
            <td> 
             <div class="btn-group">
               ...
               <ul class="dropdown-menu" role="menu">
                 ...
                 <li><a data-toggle="modal" href="{{URL('/editnotice',$datas['slug'])}}">Edit</a></li>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <h4 class="modal-title">View {{$datas['category']}}</h4>
        </div>
        <div class="modal-body">
          <strong>Title</strong>
                <p>{{e($datas['title'])}}</p><br>
                <strong>Category</strong>
                <p>{{e($datas['category'])}}</p><br>
                <strong>Description</strong>
                <p>{!!$datas['description']!!}</p><br>
                <strong>{{$datas['category']}} Date</strong>
                <p>{{e($datas['noticedate'])}}</p><br>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title">{{$datas['category']}}</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                  ...
                  <form action="{{url('/deletenotice/'.$datas['slug'])}}" method="POST">
                    @method('DELETE')
