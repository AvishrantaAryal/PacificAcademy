...
class TestimonialsController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect('/testimonials')->with('success','Inserted Successfully');
    }
    ...
    public function update($slug)
    {
        ...
        return redirect('/testimonials')->with('success','Updated Successfully');
    }
    ...
    public function updatestatus($slug)
    {
      ...
      return redirect('/testimonials')->with('success','Status Updated Successfully');
    ...
    public function destroy($slug)
    {
        ...
        return redirect('/testimonials')->with('error','Deleted Successfully');
    }
}
