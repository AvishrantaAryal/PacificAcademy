...
class CareerController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect('/career')->with('success','Inserted Successfully');
    }
    ...
    public function update($slug)
    {
        ...
        return redirect('/career')->with('success','Updated Successfully');
    }
    ...
    public function updatestatus($slug)
    {
      ...
      return redirect('/career')->with('success','Status Updated Successfully');
    ...
    public function destroy($slug)
    {
        ...
        return redirect('/career')->with('error','Deleted Successfully');
    }
}
