...
class GalleryController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect('/gallery')->with('success','Inserted Successfully');
    }
    ...
    public function updatestatus($slug)
    {
      ...
      return redirect('/gallery')->with('success','Status Updated Successfully');
    ...
    public function destroy($slug)
    {
        ...
        return redirect('/gallery')->with('error','Deleted Successfully');
    }
}
