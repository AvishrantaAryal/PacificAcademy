...
class AboutController extends Controller
{
		...
		public function store()
	    {
	        ...
	        return redirect('/about')->with('success','Inserted Successfully');
	    }
	     ...
	     public function updatestatus($slug)
	    {
	      ...
	      return redirect('/about')->with('success','Status Updated Successfully');
	      ...
	      public function destroy($slug)
		  {
		    ...
		    return redirect('/about')->with('error','Deleted Successfully');
		  }
}
