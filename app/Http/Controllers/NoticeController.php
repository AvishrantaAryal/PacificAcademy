...
class NoticeController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect('/notice')->with('success','Inserted Successfully');
    ...
    public function update($slug)
    {
        ...
        return redirect('/notice')->with('success','Updated Successfully');
    }
    ...
    public function updatestatus($slug)
    {
      ...
      return redirect('/notice')->with('success','Status Updated Successfully');
    ...
    public function destroy($slug)
    {
        ...
        return redirect('/notice')->with('error','Deleted Successfully');
    }
}
